 ...
 * @author Vivek Pandey
 */
public class MerbApplication extends AbstractRackApplication {

    public MerbApplication(Ruby ruby, RackGrizzlyAdapter adapter) {
    ...
    private static IRubyObject createApplicationObject(Ruby runtime, RackGrizzlyAdapter adapter) {
        ...
        return runtime.evalScriptlet("Rack::Handler::Grizzly.new($merb_app)");
    }
}
